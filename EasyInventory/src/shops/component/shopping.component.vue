<template>
  ...
  <div class="form">
    <form @submit="onSubmit" class="flex flex-column gap-2">
      ...
      <pv-calendar showButtonBar id="date" v-model="date" :class="{ 'p-invalid': dateError }"
      ...
      <pv-input-number mode="currency" currency="USD" locale="en-US" id="unit-price" v-model="unitPrice"
                       aria-describedby="text-error"/>
